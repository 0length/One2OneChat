package ga.bolehju.one2onechat.adapters
...
import ga.bolehju.one2onechat.widgets.CircleTransform
 ...
 **/
class ChatListAdapter(private val mContext: Context, items: ArrayList<ChatMessage>) : RecyclerView.Adapter<ChatListAdapter.ViewHolder>(),
    Filterable {
